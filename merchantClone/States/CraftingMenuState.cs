...
namespace merchantClone.States
{
    public class ScrollPane : Component
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _button.Position = new Vector2(0, _position.Y + (ComponentGroups.Count * (_compHeight + 50)));
            _button.TouchRectangle = new Rectangle(0, (int)_position.Y + (ComponentGroups.Count * (_compHeight + 50)) + 100, _texture.Width, _texture.Height);
    ...
    public class CraftingMenuState : State
    {
        ...
        public CraftingMenuState(Game1 game, GraphicsDevice graphics, ContentManager content) : base(game, graphics, content)
        {
            ...
            _scrollPane = new ScrollPane(game, new List<ComponentGroup>() { cg1 }, _newPerson, new Rectangle(0, _texture.Height, _deviceWidth, graphics.Viewport.Height - ((_texture.Height + _margin) * 2)), _texture);
        ...
        private void GeneratePersonComponent()
        {
            ...
            Button test1 = new Button(_texture, _font) { Text = "new test1"};
            Button test2 = new Button(_texture, _font) { Text = "new test2"};
            Button test3 = new Button(_texture, _font) { Text = "new test3"};
